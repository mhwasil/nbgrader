function FormGrader (base_url, submission_id, task_id) {
...
FormGrader.prototype.navigateTo = function (location) {
    return this.base_url + '/hbrs_submissions/' + this.submission_id + '/' + this.task_id + '/' + location + '?index=' + this.current_index;
};
...
var formgrader = new FormGrader(base_url, submission_id, task_id);
