...
var SubmittedNotebooks = Backbone.Collection.extend({
    ...
    url: base_url + "/formgrader/api/taskview/submitted_notebooks/" + assignment_id + "/" + notebook_id + "/" + task_id
});
...
var SubmittedNotebookUI = Backbone.View.extend({
    ...
    render: function () {
        ...
        this.$name.append($("<a/>")
            ...
            .attr("href", base_url + "/formgrader/hbrs_submissions/" + this.model.get("id") + "/" + task_id)
