...
var Notebooks = Backbone.Collection.extend({
    model: Notebook,
    url: base_url + "/formgrader/api/taskview/solution_cells/" + assignment_id + "/" + notebook_id
});
...
var NotebookUI = Backbone.View.extend({
    ...
    render: function () {
        ...
        this.$name.append($("<a/>")
            .attr("href", base_url + "/formgrader/gradebook_tasks/" + assignment_id + "/" + notebook_id + "/" + name)
            .text(name));
