...
<script src="{{ resources.base_url }}/formgrader/static/js/formgrade_taskview.js"></script>
<script type="text/javascript">
    ...
    <div class="container">
      <div class="col-md-2">
        <ul class="nav navbar-nav navbar-left">
          <li class="previous">
            <a data-toggle="tooltip" data-trigger="hover" data-placement="right" title="{{ resources.index }} remaining" href="{{ resources.base_url }}/formgrader/hbrs_submissions/{{ resources.submission_id }}/{{ resources.task_id }}/prev">
            &larr; Prev
            </a>
          </li>
        </ul>
      ...
      <div class="col-md-8">
        <ul class="nav text-center">
          <ul class="breadcrumb">
            <li><a href="{{ resources.base_url }}/formgrader/gradebook_tasks">Manual Grading (Task View)</a></li>
            <li><a href="{{ resources.base_url }}/formgrader/gradebook_tasks/{{ resources.assignment_id }}">{{ resources.assignment_id }}</a></li>
            <li><a href="{{ resources.base_url }}/formgrader/gradebook_tasks/{{ resources.assignment_id }}/{{ resources.notebook_id }}">{{ resources.notebook_id }}</a></li>
            <li><a href="{{ resources.base_url }}/formgrader/gradebook_tasks/{{ resources.assignment_id }}/{{ resources.notebook_id }}/{{ resources.task_id }}">{{ resources.task_id }}</a></li>
      ...
      <div class="col-md-2">
        <ul class="nav navbar-nav navbar-right">
          <li class="next">
            <a class="tabbable" data-trigger="hover" data-toggle="tooltip" data-placement="left" title="{{ resources.total - (resources.index + 1) }} remaining" href="{{ resources.base_url }}/formgrader/hbrs_submissions/{{ resources.submission_id }}/{{ resources.task_id }}/next">
            Next &rarr;
            </a>
          </li>
        </ul>
